    ...
    options: {
      ...
      plugins: {
        legend: {
          position: 'top',
          align: 'start',
          labels: { color: ink, font: { weight: '600', family: fontFamily, size: 12 }, usePointStyle: true, pointStyle: 'rectRounded', padding: 14 },
        },
        tooltip: {
      ...
      scales: {
        x: {
          ticks: { color: muted, font: { family: fontFamily, weight: '500', size: 11 }, maxRotation: 0, autoSkip: true, padding: 10 },
